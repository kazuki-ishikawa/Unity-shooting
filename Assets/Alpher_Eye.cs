...
public class Alpher_Eye : MonoBehaviour {
    ...
    void Update()
    {
        if (flag == 0)
        {
            GetComponent<Renderer>().material.shader = Shader.Find("UnityChan/Eye");
            GetComponent<Renderer>().material.color = new Color(r, g, b, a);
        }
        else if (flag == 1)
        {
            GetComponent<Renderer>().material.shader = Shader.Find("UnityChan/Eye - Transparent");
